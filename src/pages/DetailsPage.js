...
const DetailsPage = () => {
    ...
    const { data: castData, loading: castDataLoading } = useFetchDetails(`/${params?.explore}/${params?.id}/credits`);
    const { data: similarData, loading: similarDataLoading } = useFetch(`/${params?.explore}/${params?.id}/similar`);
    const { data: recommendationData, loading: recommendationDataLoading } = useFetch(
    ...
    return (
        <div>
            ...
            <div>
                <Slider data={similarData} heading={'Similar ' + params?.explore} media_type={params?.explore} />
                <Slider
